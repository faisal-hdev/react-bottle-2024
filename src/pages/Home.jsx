...
const Home = () => {
  return (
    <div className="min-h-full text-gray-900">
      ...
      <div className="container flex flex-col justify-center mx-auto pb-24 lg:flex-row lg:justify-between">
        <div className="flex flex-col justify-center  text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
          ...
          <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
            <Link className="px-8 py-3 text-sm md:text-lg font-semibold rounded bg-violet-400 text-gray-900">
              Suspendisse
            </Link>
            <Link className="px-8 py-3 text-sm md:text-lg font-semibold border rounded border-gray-100">
              Malesuada
            </Link>
          </div>
        </div>
